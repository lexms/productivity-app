      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setFormData({ ...formData, daily_goal_tasks: Number.parseInt(e.target.value) })}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setFormData({ ...formData, daily_goal_points: Number.parseInt(e.target.value) })}
          />
        </div>
      </div>
